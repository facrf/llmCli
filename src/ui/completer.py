...
SLASH_COMMANDS = [
    ...
    ("/web", "Pesquisa informações e documentações na web (ex: /web fastapi rotas)"),
    ...
    ("/gentest", "Gera suíte completa de testes unitários com pytest para o arquivo (ex: /gentest src/config.py)"),
